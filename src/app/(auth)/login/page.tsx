  ...
  return (
    <div className="w-full max-w-md animate-fade-in">
      ...
      <div className="glass rounded-2xl p-8 shadow-2xl shadow-black/5 dark:shadow-black/20">
        ...
        {/* Error message */}
        {error && (
          <div className="flex items-center gap-2 rounded-lg bg-destructive/10 border border-destructive/20 p-3 mb-6 text-sm text-destructive">
        ...
        <div className="space-y-3">
          <Button
            variant="outline"
            className="w-full h-11 gap-3 font-medium hover:bg-accent transition-all"
